...
public class DocumentDAO {
    ...
    public int saveDocument(Document doc) {
        String sql = "INSERT INTO documents (box_id, created_at) VALUES (?, SYSDATETIME())\";";
    ...
    private void saveFiles(Connection con, Document doc) {
        ...
        String sql = "INSERT INTO files(file_name, file_number, document_id,is_barcode," +
    ...
    public void updateMetadata(int documentId, String metadata) {
        String sql = "UPDATE documents SET metadata = ? WHERE id = ?";
    ...
    public void updateFileOrder(Document doc) {
        String sql = "UPDATE files SET file_number = ? WHERE document_id = ? AND id = ?";
